...
export class BarChart implements IVisual {
    ...
    private barContainer: Selection<d3.BaseType, any, d3.BaseType, any>;
    private xAxis: Selection<d3.BaseType, any, d3.BaseType, any>;
    private barDataPoints: BarChartDataPoint[];
    private barChartSettings: BarChartSettings;
    private tooltipServiceWrapper: ITooltipServiceWrapper;
    private locale: string;
    private helpLinkElement: Selection<d3.BaseType, any, d3.BaseType, any>;

    private barSelection: Selection<d3.BaseType, any, d3.BaseType, any>;
    ...
    private syncSelectionState(
        selection: Selection<d3.BaseType, BarChartDataPoint, d3.BaseType, BarChartDataPoint>,
    ...
    private createHelpLinkElement(): Element {
        ...
        linkElement.classList.add("helpLink");
